...
public class GiftTestScenarioBuilder extends TestScenarioBuilder{
	public static List<PersonData> buildTestCaseOnePersonGift(double paymentA, HashSet<String> giftReceivers, double giftValue) {
		List<PersonData> inputPaysList = new  ArrayList<PersonData>();
		inputPaysList.add(new PersonData(Constants.personAName, paymentA, new HashSet<String>(), giftReceivers.contains(Constants.personAName), giftValue));
