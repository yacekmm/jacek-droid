...
public class PersonAtomPaysListTest extends TestCase {
	...
	public void test1PersonAtomPaysList(){
		...
		assertEquals(Constants.INCORRECT_ATOM_PAYMENTS_SUM, 25.0, pd.getHowMuchPersonPaid());
	}
	...
	public void testPerson2AtomPaysList(){
		...
		assertEquals(Constants.INCORRECT_ATOM_PAYMENTS_SUM, 62.0, pd.getHowMuchPersonPaid());
	}
